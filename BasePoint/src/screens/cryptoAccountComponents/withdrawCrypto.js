...
import {NODE_ENV_NETWORKS, contentColor, headerColor, networksRPCs} from "../../../env"
...
class WithdrawCrypto extends Component {
    ...
    componentDidMount() {
        ...
        this.web3 = new Web3(networksRPCs[this.context.value.networkSelected])
            ...
            <View style={GlobalStyles.container}>
                <Header />
                {
                    <View style={{ position: "absolute", top: 9, left: 18 }}>
                        <Pressable onPress={() => this.props.navigation.navigate('CryptoAccount')}>
                            <IconMCI name="arrow-back-ios" size={36} color={NODE_ENV_NETWORKS[this.context.value.networkSelected].color} />
                        </Pressable>
                    </View>
                }
                {
                ...
                }
                {
                    ...
                    <View style={[GlobalStyles.mainSub, { flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }]}>
                        ...
                        <View style={{ borderBottomWidth: 2, borderColor: NODE_ENV_NETWORKS[this.context.value.networkSelected].color, width: "90%" }} />
                ...
                }
                {
                    this.state.stage === 4 &&
                    <View style={[GlobalStyles.mainSub, { flexDirection: "column", justifyContent: "space-evenly", alignItems: "center" }]}>
                        <Icon2 name="check-circle" size={240} color={NODE_ENV_NETWORKS[this.context.value.networkSelected].color} />
                        <Text style={{
                            textShadowRadius: 1,
                        ...
                        <Pressable style={[GlobalStyles.button,{backgroundColor:NODE_ENV_NETWORKS[this.context.value.networkSelected].color}]} onPress={() => {
