            ...
            <>
                <View style={GlobalStyles.container}>
                    ...
                    <View style={[GlobalStyles.mainSub, { flexDirection: "column", justifyContent: "space-evenly", alignItems: "center", paddingTop: 10 }]}>
                        ...
                        <View style={{ backgroundColor: NODE_ENV_NETWORKS[this.context.value.networkSelected].color, height: 2, width: "90%", marginVertical: 10 }} />
                                ...
                                <View style={{ justifyContent: "center", alignItems: "center" }}>
                                    ...
                                    <View >
                                        <Pressable
                                            ...
                                            style={[GlobalStyles.button,{backgroundColor:NODE_ENV_NETWORKS[this.context.value.networkSelected].color}]}
                                            onPress={() => {
